...
```sh
go get -u 'github.com/hyperspell/hyperspell-go@v0.2.0'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/hyperspell/hyperspell-go/option).
...
We also provide a helper `hyperspell.NewFile(reader io.Reader, filename string, contentType string)`
