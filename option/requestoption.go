...
// RequestOption is an option for the requests made by the hyperspell API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/hyperspell-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.hyperspell.com/")
}
...
// WithUserID returns a RequestOption that sets the client setting "user_id".
